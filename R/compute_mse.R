...
#'
#' @description This function compute the weights A and the mean squared error defined by def 2.2 in the paper. The computation follows appendix B: nuclear norm regularized "partialling out" regression
#'
