...
#'
#' @details
#' The design follows that data generating process of the simulation in Armstrong, Weidner, and Zeleneev (2023, "Robust Estimation and Inference in Panels with Interactive Fixed Effects").
